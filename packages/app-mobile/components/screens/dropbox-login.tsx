		...
		return (
			<View style={this.styles().screen}>
				...
				<ScrollView style={this.styles().container}>
					...
					<TextInput placeholder={_('Enter code here')} placeholderTextColor={theme.colorFaded} selectionColor={theme.textSelectionColor} keyboardAppearance={theme.keyboardAppearance} value={this.state.authCode} onChangeText={this.shared_.authCodeInput_change} style={theme.lineInput} autoCapitalize="none" autoCorrect={false} />
